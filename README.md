...
The **Navi-Gator** is a smart, user-friendly platform designed to simplify navigation within RTU college campus.  
...
- **Cross-Platform Accessibility**  
  will be deployed as a web application, accessible from laptops, mobile etc.
